			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="/admin/assets/#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="/admin/assets/#stroked-male-user"></use></svg> admin <span class="caret"></span></a>
